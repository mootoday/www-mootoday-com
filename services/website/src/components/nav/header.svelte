...
<nav in:fade class="fixed bg-gray-900 mt-0 w-full">
  <div
    class="container px-4 md:px-0 max-w-6xl mx-auto">
    <div class="mx-0 sm:mx-6 flex items-center justify-between">
      ...
      <div class="flex text-sm">
        <ul
          ...
          <li class="mr-2">
            <a
              class="inline-block py-2 px-2 no-underline hover:underline
              uppercase"
              href="markua-support">
              Markua Support
            </a>
