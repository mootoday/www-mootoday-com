                ...
                <nav class="pointer-events-auto hidden md:block">
                  ...
                  >
                    {#each navigationItems as {href, label}}
                      <li>
                        <a
                          class:text-teal-500={$page.url.pathname.startsWith(href)}
                          class:dark:text-teal-400={$page.url.pathname.startsWith(href)}
                          class:hover:text-teal-500={!$page.url.pathname.startsWith(href)}
                          class:dark:hover:text-teal-400={!$page.url.pathname.startsWith(href)}
